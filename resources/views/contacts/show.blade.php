            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container px-5 mx-auto">
                        ...
                        <form id="delete_{{ $contact->id }}" method="post" action="{{ route('contacts.destroy',['id' => $contact->id ]) }}" > 
                            @csrf
            <a href="#" data-id="{{ $contact->id }}" onclick="deletePost(this)" class=" text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">削除する</a>
                        </form></div>
